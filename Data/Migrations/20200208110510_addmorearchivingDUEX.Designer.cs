...
namespace Recitopia.Data.Migrations
{
    ...
    [Migration("20200208110510_addmorearchivingDUEX")]
    partial class addmorearchivingDUEX
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Recitopia.Models.BuildPlan", b =>
                {
                    b.Property<int>("BuildPlan_Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasKey("BuildPlan_Id");

                    b.ToTable("BuildPlan");
                });

            modelBuilder.Entity("Recitopia.Models.BuildPlan_Recipes", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasIndex("BuildPlan_Id1");

                    b.HasIndex("Recipe_Id1");

                    b.ToTable("BuildPlan_Recipes");
                });
            ...
            modelBuilder.Entity("Recitopia.Models.Packaging", b =>
                {
            ...
            modelBuilder.Entity("Recitopia.Models.Recipe_Packaging", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int?>("PackagingPackage_Id")
                        .HasColumnType("int");
                    ...
                    b.Property<decimal>("Weight_g")
                        .HasColumnType("decimal(18,3)");

                    b.HasKey("Id");

                    b.HasIndex("PackagingPackage_Id");

                    b.HasIndex("Recipe_Id1");

                    b.ToTable("Recipe_Packaging");
                });
            ...
            modelBuilder.Entity("Recitopia.Models.BuildPlan_Recipes", b =>
                {
                    b.HasOne("Recitopia.Models.BuildPlan", "BuildPlan")
                        .WithMany("BuildPlan_Recipes")
                        .HasForeignKey("BuildPlan_Id1");
            ...
            modelBuilder.Entity("Recitopia.Models.Recipe_Packaging", b =>
                {
                    b.HasOne("Recitopia.Models.Packaging", "Packaging")
                        .WithMany("Recipe_Packaging")
                        .HasForeignKey("PackagingPackage_Id");
