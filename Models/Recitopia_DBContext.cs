...
namespace Recitopia.Models
{
    public partial class Recitopia_DBContext : DbContext 
    {
        ...
        public Recitopia_DBContext(DbContextOptions<Recitopia_DBContext> options)
            : base(options)
        {
            var builder = new Microsoft.Extensions.Configuration.ConfigurationBuilder()
             .SetBasePath(AppContext.BaseDirectory)
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Ingredient_Components>(entity =>
            {
                entity.Property(e => e.Customer_Id).HasDefaultValueSql("((1))");
            ...
            modelBuilder.Entity<Ingredient_Nutrients>(entity =>
            {
                entity.Property(e => e.Customer_Id).HasDefaultValueSql("((1))");
            ...
            modelBuilder.Entity<Meal_Category>(entity =>
            {
            ...
            modelBuilder.Entity<Serving_Sizes>(entity =>
            {
            ...
            modelBuilder.Entity<View_All_Ingredient_Components>(entity =>
            {
                entity.HasNoKey();
            ...
            modelBuilder.Entity<View_All_Ingredient_Nutrients>(entity =>
            {
                entity.HasNoKey();
            ...
            modelBuilder.Entity<View_All_Recipe_Components>(entity =>
            {
                entity.HasNoKey();
            ...
            modelBuilder.Entity<View_All_Recipe_Ingredients>(entity =>
            {
                entity.HasNoKey();
            ...
            modelBuilder.Entity<View_Angular_Ingredient_Components_Details>(entity =>
            {
                entity.HasNoKey();
            ...
            modelBuilder.Entity<View_Angular_Ingredient_Nutrients_Details>(entity =>
            {
                entity.HasNoKey();
            ...
            modelBuilder.Entity<View_Angular_Ingredients_Details>(entity =>
            {
                entity.HasNoKey();
            ...
            modelBuilder.Entity<View_Angular_Recipe_Details>(entity =>
            {
                entity.HasNoKey();
            ...
            modelBuilder.Entity<View_Angular_Recipe_Ingredients_Details>(entity =>
            {
                entity.HasNoKey();
            ...
            modelBuilder.Entity<View_Nutrition_Panel>(entity =>
            {
                entity.HasNoKey();
